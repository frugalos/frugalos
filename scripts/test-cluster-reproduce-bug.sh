...
SEGMENT_ALLOCATION_POLICY='"SCATTER_IF_POSSIBLE"'
...
{"virtual": {
  "id": "rack0-sub",
  "policy": ${SEGMENT_ALLOCATION_POLICY},
  "children": [${DEVICES}]
}}
EOF
    )
curl -XPUT -d "$JSON" http://localhost:${PORT}/v1/devices/rack0-sub
...
## update the intermediate device
