//! Definitions for frugalos delete-bucket-contents
...
pub struct DeleteBucketContentsCommand;

impl FrugalosSubcommand for DeleteBucketContentsCommand {
    ...
    fn handle_matches(
        ...
        track_try_unwrap!(crate::daemon::delete_bucket_contents(
            &logger,
            rpc_addr,
            bucket_seqno
        ));
